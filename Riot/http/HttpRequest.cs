...
namespace Riot
{
    public class HttpRequest
    {
        ...
        /// Get response from specified url
        /// </summary>
        public string Post(string url, string json, IDictionary<string, string> requestHeaderParams, bool keepAlive)
        {
            HttpWebResponse response;
            return Post(url, json, requestHeaderParams, out response, keepAlive);
        }

        /// <summary>
        /// Get response from specified url
        /// </summary>
        public string Post(string url, string json, IDictionary<string, string> requestHeaderParams, out HttpWebResponse httpResponse, bool keepAlive)
        {
            HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
            httpWebRequest.ContentType = "application/json";
